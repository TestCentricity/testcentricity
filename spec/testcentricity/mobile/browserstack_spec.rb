...
RSpec.describe TestCentricity::AppiumConnect, browserstack: true do
  ...
  before(:context) do
    ...
    ENV['AUTOMATE_PROJECT'] = 'TestCentricity - BrowserStack'
    ENV['AUTOMATE_BUILD'] = "Version #{TestCentricity::VERSION}"
