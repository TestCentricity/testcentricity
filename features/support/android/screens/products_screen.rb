class ProductsScreen < BaseAppScreen
  ...
  list    :product_grid, { xpath: '//android.widget.ScrollView' }
  section :product_grid_item, ProductGridItem

  def initialize
    super
    # define the list item element for the Product table object
    ...
    # associate the Product Grid Item indexed section object with the Product table object
